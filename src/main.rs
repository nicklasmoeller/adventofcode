...
fn main() {
    ...
    let day: Box<dyn AdventOfCode> = match (opt.year, normalized_day) {
        ...
        (2020, 01) => Box::new(years::year2020::Day01 {}),
        (2020, 02) => Box::new(years::year2020::Day02 {}),
        (2020, 03) => Box::new(years::year2020::Day03 {}),
        (2020, 04) => Box::new(years::year2020::Day04 {}),
        (2020, 05) => Box::new(years::year2020::Day05 {}),
        (2020, 06) => Box::new(years::year2020::Day06 {}),
        (2020, 07) => Box::new(years::year2020::Day07 {}),
        (2020, 08) => Box::new(years::year2020::Day08 {}),
        (2020, 09) => Box::new(years::year2020::Day09 {}),
        (2020, 10) => Box::new(years::year2020::Day10 {}),
        (2020, 11) => Box::new(years::year2020::Day11 {}),
